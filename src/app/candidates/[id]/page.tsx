...
import { SendEmailView } from '@/app/candidates/[id]/SendEmailView'
            ...
            <div className="min-h-screen bg-background pb-20 font-sans text-foreground">
                ...
                <div className="bg-card border-b border-border shadow-sm mb-4">
                    <div className="max-w-[1000px] mx-auto flex items-center gap-6 px-4 py-3 text-[14px] font-medium text-muted-foreground">
                        ...
                        <button
                            className={`flex items-center gap-1.5 hover:text-primary transition-colors ${showSendEmail ? 'text-primary' : ''}`}
                            onClick={() => setShowSendEmail(!showSendEmail)}
                        >
                            <Send className="w-4 h-4" /> {showSendEmail ? 'Back to Profile' : 'Send Email'}
                        </button>
